...
<body>
    <h1 align="center">Issue a Book </h1>
<div class="issuebook-form">
    <form action="issuebook">
            
         <div class="form-group">
            <input type="text" class="form-control" placeholder="Enter User Id"  name="uid" required="required">
        </div>
        <div class="form-group">
            <input type="text" class="form-control" placeholder="Enter Book Id"  name="bid" required="required">
        </div>
